    ...
    <div class="dateprice_table_container">
        ...
        <div class="dateprice_table_body_container">
            ...
            <?php foreach ($result as $key => $value) { ?>
                <div class="dateprice_table_row <?php if ($value->tourstatus == "soldout") {
                                                    echo "soldout";
                    ...
                    <div class="row_card_items">
                            ...
                            <div class="table_item_content">
                                ...
                                <?php switch ($value->tourstatus) {
                                    case 'available':
                                        ...
                                        break;
                                    case 'guaranteed':
                                        echo "<div class='status_container' style='color: #f1592a;display: flex;justify-content: center;align-items: center;width: 140px;font-size: 13px;'><div class='status_icon_dateandprice_guaranteed' style='padding: 10px;background-repeat: no-repeat;'></div>  Tour Guaranteed</div>";
                                        break;
                                    case 'fillingfast':
                                        echo "<div class='status_container' style='color: #ffab12; flex; justify-content: center;align-items: center;width: 104%;font-size: 13px;'><div class='status_icon_dateandprice_limited_availability'></div>  Limited Availability</div>";
                                        break;
                                    case 'soldout':
                        ...
                        <?php if ($value->tourstatus != "soldout") { ?>
