                               ...
                               ?>
                                <?php switch ($value->tourstatus) {
                                    ...
                                    case 'guaranteed':
                                        ...
                                        break;
                                    case 'fillingfast':
                                        echo $icon_in_high_demand . "<div class='status_container' style='color: blue;display: flex;justify-content: center;align-items: center;'><div class='status_icon_dateandprice_limited_availability'></div>In High Demand</div>";
                                        break;
                                    case 'almostsoldout':
