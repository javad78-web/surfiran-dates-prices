                               ...
                               ?>
                                <?php switch ($value->tourstatus) {
                                    ...
                                    case 'guaranteed':
                                        ...
                                        break;
                                    case 'fillingfast':
                                        echo $icon_in_high_demand . "<div class='status_container' style='color: blue;display: flex;justify-content: center;align-items: center;'><div class='status_icon_dateandprice_in_high_demand'></div>In High Demand</div>";
                                        break;
                                    case 'almostsoldout':
                                        ...
                                        break;
                                    case 'soldout':
                                        echo $icon_sold_out . "<div class='status_container' style='color: #ffab12; display: flex;justify-content: center;align-items: center;'><div class='status_icon_dateandprice_sold_out'></div>Sold Out</div>";
                                        break;
                                } ?>
                            </div>
                        </div>
